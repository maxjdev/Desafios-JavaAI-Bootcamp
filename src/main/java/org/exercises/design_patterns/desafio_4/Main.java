package org.exercises.design_patterns.desafio_4;
...
class ShoppingCart {
    ...
    public double calculateTotal() {
        ...
        return discountStrategy.applyDiscount(
                products.stream().reduce(0.0, Double::sum));  // Retornar o total calculado
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        Double totalCompras = cart.calculateTotal();
